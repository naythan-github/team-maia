-- SYSTEM_STATE Hybrid Database Schema v2
-- Phase 167: Decimal Phase Support Migration
-- Agent: SRE Principal Engineer Agent
-- Date: 2025-11-21
-- Changes: phase_number INTEGER → TEXT (supports 151.2, 134.4)
...
CREATE TABLE IF NOT EXISTS phases (
    ...
    phase_number TEXT UNIQUE NOT NULL,  -- Changed to TEXT to support decimals (151.2, 134.4)
    title TEXT NOT NULL,
...
-- Index for fast lookups by phase number (TEXT comparison is fast)
...
-- =============================================================================
-- Views for common queries (UPDATED: Use CAST for numeric sorting)
-- =============================================================================

-- View: Recent phases with full context
-- IMPORTANT: ORDER BY uses CAST(phase_number AS REAL) for correct numeric sorting
...
VALUES (2, 'Schema v2: phase_number INTEGER → TEXT (supports 151.2, 134.4 decimals)');
