...
class OTCComment(BaseModel):
    ...
    comment_id: Optional[int] = Field(None, alias='TKTCT-CommentID')
    ticket_id: Optional[int] = Field(None, alias='TKTCT-TicketID')
    comment_text: Optional[str] = Field(None, alias='TKTCT-Comment')
    user_id: Optional[str] = Field(None, alias='TKTCT-UserID')
    user_name: Optional[str] = Field(None, alias='TKTCT-Username')
    owner_type: Optional[str] = Field(None, alias='TKTCT-OwnerType')
    created_time: Optional[datetime] = Field(None, alias='TKTCT-Created Time')
    visible_to_customer: Optional[bool] = Field(None, alias='TKTCT-VisibleCustomer')
    comment_type: Optional[str] = Field(None, alias='TKTCT-Type')
    team: Optional[str] = Field(None, alias='TKTCT-Team')
